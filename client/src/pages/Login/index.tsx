...
const useStyles = makeStyles((theme: Theme) =>
  createStyles({
    ...
    card: {
      ...
      background: "linear-gradient(to bottom right, rgba(0, 68, 137, .4), rgba(0, 68, 137, .3))",
    ...
    glassBall1: {
      ...
      background: "linear-gradient(to top left, rgba(175, 82, 191, 0.9), rgba(175, 82, 191, 0.6))",
    },
    glassBall2: {
      [theme.breakpoints.up("lg")]: {
        bottom: "12vh",
      ...
      background: "linear-gradient(to top right, rgba(175, 82, 191, 0.7), rgba(175, 82, 191, 0.4))",
    },
  })
);
