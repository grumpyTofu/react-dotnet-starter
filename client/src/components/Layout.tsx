...
import { Container, Drawer, List, Divider, IconButton, ListItem, ListItemIcon, ListItemText } from "@material-ui/core";
...
const useStyles = makeStyles((theme: Theme) =>
  createStyles({
    ...
    drawerOverride: {
      ...
      //background: "rgba(4, 91, 188, .15)",
      //color: theme.palette.common.black,
      border: "none",
      boxShadow: "1px 0px 2px -1px rgb(0 0 0 / 20%), 1px 0px 1px 0px rgb(0 0 0 / 14%), 1px 0px 3px 0px rgb(0 0 0 / 12%)",
    },
    drawerOpen: {
      width: drawerWidth,
    ...
    background: {
      ...
      left: 0,
      overflow: "hidden",
      background: "url(cobm_background.jpg)",
    ...
    backdropGlass: {
      ...
      width: "100vw",
      zIndex: -1,
      background: "linear-gradient(to bottom right, rgba(255,255,255,.3), rgba(255,255,255,.1))",
      backgroundRepeat: "no-repeat",
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.background}>
        {/* <img src="cobm_background.jpg" alt="background"></img> */}
      ...
      >
        ...
        <div className={classes.sidebarControl}>
          <List>
            ...
            >
              {open ? (
                <ListItemIcon>{theme.direction === "rtl" ? <ChevronRightIcon /> : <ChevronLeftIcon />}</ListItemIcon>
              ) : (
                <ListItemIcon>
                  <ChevronRightIcon />
                </ListItemIcon>
